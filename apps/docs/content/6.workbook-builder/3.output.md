---
title: Output
description: Finalizing a workbook to a buffer, Uint8Array, or file.
---
...
Choose exactly one finalization method per workbook instance.
...
// Option 1: get a readable stream
...
// Option 2: pipe directly to a writable
