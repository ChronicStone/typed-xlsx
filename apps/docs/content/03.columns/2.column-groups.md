...
For the full scope rules and mode differences, see [Scope & References](/formulas/scope-and-references).

For runtime-generated columns, see [Dynamic Columns](/columns/dynamic-columns).
