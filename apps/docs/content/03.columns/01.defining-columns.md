...
Columns can render status badges and checkbox glyphs via `type: "badge"` and `type: "checkbox"`. See [Badges and Checkboxes](/columns/badges-and-checkboxes) for the renderer API.
