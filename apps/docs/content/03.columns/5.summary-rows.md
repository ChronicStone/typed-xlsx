...
Summaries are post-data rows that appear below a table. They are **report-mode only** — for excel-table mode, use the [totals row](/excel-tables/totals-row) feature instead.
