...
xlsmith ships two workbook builders. Both support the same schema kinds, formula features, summaries, styling, and sheet options. The difference is in how row data flows through memory and when output is finalized.
