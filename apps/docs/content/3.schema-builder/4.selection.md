...
Selections can target plain column IDs, structural group IDs from `.group()`, and dynamic-scope IDs from `.dynamic()`. See [Groups](/schema-builder/column-groups) and [Dynamic Columns](/schema-builder/dynamic-columns).
