...
Columns support native Excel data validation via the `validation` field. See [Data Validation](/schema-builder/data-validation) for the full walkthrough.

## Hyperlinks

Columns support native Excel hyperlinks via the `hyperlink` field. See [Hyperlinks](/schema-builder/hyperlinks) for the full walkthrough.
