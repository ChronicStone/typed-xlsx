...
The benchmark generates synthetic data with a representative schema and records throughput, output size, and memory behavior for stream exports.

::callout{type="warning"}
Treat the numbers below as directional until regenerated for your machine and current branch.
::
