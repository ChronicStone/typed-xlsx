---
title: Cell Styles
description: Apply stable export-time CellStyle objects to data cells, headers, and shared style defaults.
---
...
If you want reusable semantic defaults rather than repeating literal style objects, start with [Themes](/styling/themes).

## `CellStyle`

```ts twoslash
import type { CellStyle } from "typed-xlsx";
...
Use this page for the style object itself, then see [Conditional Styles](/styling/conditional-styles) when the summary should stay live inside Excel.
