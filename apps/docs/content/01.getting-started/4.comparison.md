...
| **Rich worksheet features**       |              :warning:               |            :white_check_mark:            |             :warning: mixed             | :white_check_mark: |
...
- **ExcelJS** — best when you need lower-level workbook manipulation plus charts, freeform drawings, comments, and rich text.
...
- **Images / comments / rich text** — `typed-xlsx` supports schema-driven image columns; `hucre` and ExcelJS cover a broader worksheet feature surface for freeform drawings, comments, and rich text.
...
If you specifically need conversion-heavy interoperability, choose SheetJS. If you specifically need imperative workbook editing with chart, drawing, or comment-heavy workflows, choose ExcelJS.
