...
`@chronicstone/typed-xlsx` ships as **ESM-only**. It works in Node.js, Bun, Deno, Cloudflare Workers, and any runtime with standard `ReadableStream` / `WritableStream` support. No native addons, no peer dependencies.
