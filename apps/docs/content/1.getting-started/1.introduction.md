...
- Build your first report — [Quick Start: Buffered](/getting-started/quick-start-buffered)
- Export 100k rows without memory spikes — [Quick Start: Streaming](/getting-started/quick-start-streaming)
