---
title: Installation
description: Install typed-xlsx with npm, pnpm, yarn, or bun.
---
...
`createExcelSchema()` defaults to report mode. Pass `createExcelSchema({ mode: "excel-table" })` when you want a native Excel table schema instead.
