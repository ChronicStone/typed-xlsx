...
| Memory model       | Full dataset in heap    | Bounded by batch size                   |
...
If your dataset fits comfortably in memory, use the buffered builder. The commit-based API adds async complexity; only reach for it when you actually need bounded memory.
