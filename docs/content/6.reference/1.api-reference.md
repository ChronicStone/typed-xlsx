...
// ---cut---
const schema = createSchema<Row>().column("name", { accessor: "name" }).build();
```
...
| Field     | Type                                         | Description                                          |
| --------- | -------------------------------------------- | ---------------------------------------------------- |
| `schema`  | `SchemaDefinition<T>`                        | Built schema from `createSchema<T>().build()`.       |
| `rows`    | `T[]`                                        | Data rows.                                           |
...
| `select`  | `{ include?: string[]; exclude?: string[] }` | Column selection.          |
| `context` | `Record<string, unknown>`                    | Group context values.      |
